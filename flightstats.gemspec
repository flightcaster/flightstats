...
= Usage
  ...
  s.files = ["ext/hash.rb", "ext/string.rb", "flightstats.gemspec", "lib/flight_stats.rb", "lib/flightstats/airline.rb", "lib/flightstats/airport/delay/closed_delay.rb", "lib/flightstats/airport/delay/general_arrival_delay.rb", "lib/flightstats/airport/delay/general_delay.rb", "lib/flightstats/airport/delay/general_departure_delay.rb", "lib/flightstats/airport/delay/ground_delay.rb", "lib/flightstats/airport/delay/ground_stop_delay.rb", "lib/flightstats/airport/delay.rb", "lib/flightstats/airport.rb", "lib/flightstats/flight.rb", "lib/flightstats/metar.rb", "lib/flightstats/weather_forecast.rb", "lib/flightstats.rb", "Manifest", "Rakefile", "README.rdoc"]
  s.has_rdoc = true
